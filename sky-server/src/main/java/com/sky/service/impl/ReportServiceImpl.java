...
public class ReportServiceImpl implements ReportService {
    ...
    public TurnoverReportVO getTurnoverStatistics(LocalDate begin, LocalDate end) {
        ...
        for (LocalDate date : dateList) {
            ...
            turnover = turnover == null ? 0.0 : turnover;//如果当前营业额为空则设置为0.0
    ...
    public void exportBussinessData(HttpServletResponse response) {
        ...
        try {
            ...
            for (int i = 0; i < 30; i++) {
                ...
                //查询某一天的营业数据
                BusinessDataVO bussinessData = workspaceService.getBusinessData(LocalDateTime.of(date, LocalTime.MIN), LocalDateTime.of(date, LocalTime.MAX));
